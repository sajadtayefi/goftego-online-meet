...
const WhyGoftego = () => {
    return (
        <div className="text-white container flex flex-col mx-auto justify-center items-center xl:pb-0 lg:mb-0">
            ...
            <p className=" xl:w-[1000px] p-4 xl:text-[14px] text-[12px]  text-center   " >
            ...
            <div className="flex flex-col lg:flex-row xl:mt-10 mt-10 justify-center items-center lg:justify-evenly w-full">
