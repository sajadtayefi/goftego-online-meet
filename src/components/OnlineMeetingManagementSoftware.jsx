        ...
        <div className="flex pt-5 relative container mx-auto xl:mb-32  mb-16 ">
            ...
            <div className="flex flex-col lg:flex-row-reverse justify-center items-center  ">
                ...
                <div className="text-white w-full lg:w-1/2 px-10 lg:px-0">
                    <h2 className="  xl:font-semibold lg:px-0  xl:text-5xl lg:text-4xl text-[24px] font-[500px] 2xl:text-6xl mb-2 ">
                        ‌‌‌‌‌نرم افزار آنلاین مدیریت جلسات <span className=" leading-[8rem] text-secondary">گفتگو</span>
                    </h2>
                    ...
                    <div className="flex flex-row xl:mt-10 mt-4 ">
                        <Image className=" w-[30%] xl:w-1/6" src={"/icons/Google Play 1.svg"} width={150} height={150} />
                        <Image className="md:mx-5 mx-1 w-[30%] xl:w-1/6" src={"/icons/Bazar 1.svg"} width={150} height={150} />
                        <Image className=" w-[30%] xl:w-1/6" src={"/icons/Myket 1.svg"} width={150} height={150} />
                    </div>
                </div>
